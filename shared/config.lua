...
Config.PenalCode = {
    ...
    -- },
	[1] = {
	    [1] = {title = "Voies de fait simples", class = "Délit", id = "C.P. 1001", months = 7, fine = 500, color = "vert", description = "Quand une personne cause intentionnellement ou sciemment un contact physique avec une autre (sans arme)"},
	    ...
	    [4] = {title = "Agression avec une arme mortelle", class = "Crime", id = "C.P. 1004", months = 30, fine = 3750, color = "rouge", description = "Quand une personne cause intentionnellement, sciemment ou imprudemment des blessures corporelles à une autre personne ET provoque soit des blessures corporelles graves soit utilise ou exhibe une arme mortelle"},
	    [5] = {title = "Homicide involontaire", class = "Crime", id = "C.P. 1005", months = 60, fine = 7500, color = "rouge", description = "Quand une personne cause involontairement et imprudemment la mort d'une autre"},
	    [6] = {title = "Homicide par véhicule", class = "Crime", id = "C.P. 1006", months = 75, fine = 7500, color = "rouge", description = "Quand une personne cause involontairement et imprudemment la mort d'une autre avec un véhicule"},
	    [7] = {title = "Tentative de meurtre d'un civil", class = "Crime", id = "C.P. 1007", months = 50, fine = 7500, color = "rouge", description = "Quand une personne non gouvernementale attaque intentionnellement une autre avec l'intention de tuer"},
	    [8] = {title = "Meurtre au deuxième degré", class = "Crime", id = "C.P. 1008", months = 100, fine = 15000, color = "rouge", description = "Tout meurtre intentionnel qui n'est pas prémédité ou planifié. Une situation dans laquelle le meurtrier a l'intention seulement de causer des lésions corporelles graves."},
	    [9] = {title = "Complicité de meurtre au deuxième degré", class = "Crime", id = "C.P. 1009", months = 50, fine = 5000, color = "rouge", description = "Être présent et/ou participer à l'acte de parent inculpé"},
	    [10] = {title = "Meurtre au premier degré", class = "Crime", id = "C.P. 1010", months = 0, fine = 0, color = "rouge", description = "Tout meurtre intentionnel qui est délibéré et prémédité avec malice."},
	    [11] = {title = "Complicité de meurtre au premier degré", class = "Crime", id = "C.P. 1011", months = 0, fine = 0, color = "rouge", description = "Être présent et/ou participer à l'acte de parent inculpé"},
	    [12] = {title = "Meurtre d'un fonctionnaire public ou d'un agent de la paix", class = "Crime", id = "C.P. 1012", months = 0, fine = 0, color = "rouge", description = "Tout meurtre intentionnel commis à l'encontre d'un employé du gouvernement"},
	    [13] = {title = "Tentative de meurtre d'un fonctionnaire public ou d'un agent de la paix", class = "Crime", id = "C.P. 1013", months = 65, fine = 10000, color = "rouge", description = "Toutes attaques commises à l'encontre d'un employé du gouvernement dans l'intention de causer la mort"},
	    [14] = {title = "Complicité du meurtre d'un fonctionnaire public ou d'un agent de la paix", class = "Crime", id = "C.P. 1014", months = 0, fine = 0, color = "rouge", description = "Être présent et/ou participer à l'acte de parent inculpé"},
	    [15] = {title = "Emprisonnement illégal", class = "Délit", id = "C.P. 1015", months = 10, fine = 600, color = "vert", description = "L'acte de prendre une autre personne contre sa volonté et de la retenir pendant une période prolongée"},
	    ...
	    [24] = {title = "Tir lié à un gang", class = "Crime", id = "C.P. 1024", months = 30, fine = 2500, color = "rouge", description = "L'acte par lequel une arme à feu est déchargée en relation avec une activité de gang"},
	    [25] = {title = "Cannibalisme", class = "Crime", id = "C.P. 1025", months = 0, fine = 0, color = "rouge", description = "L'acte par lequel une personne consomme volontairement la chair d'une autre"},
	    [26] = {title = "Torture", class = "Crime", id = "C.P. 1026", months = 40, fine = 4500, color = "rouge", description = "L'acte de causer des dommages à une autre personne pour obtenir des informations et/ou pour son propre plaisir"},
	},
    -- [2] = {
